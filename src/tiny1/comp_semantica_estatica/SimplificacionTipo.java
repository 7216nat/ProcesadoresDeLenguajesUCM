...
public class SimplificacionTipo extends ProcesamientoPorDefecto{
    ...
    public void procesa(DVar exp) {
        ...
        log(exp.id().fila() + " " + exp.id().col()+ " " +exp.id().toString() + ": " + exp.tipo().toString() + " --> " + exp.type().toString());
    }
    ...
    public void procesa(ParRef par) {
        ...
        log(par.id().fila() + " " + par.id().col()+ " " +par.id().toString() + ": " + par.tipo().toString() + " --> " + par.type().toString());
    }
    @Override
    ...
    public void procesa(Campo c) {
        ...
        log(c.id().fila() + " " + c.id().col()+ " " +c.id().toString() + ": " + c.tipo().toString() + " --> " + c.type().toString());
    }
}